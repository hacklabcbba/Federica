...
/**
  * Created by Family on 22/05/2016.
  */
object DataTable {
  def apply(
             columns: List[String],
...
abstract class DataTableSource(val totalRecords: Long, val totalDisplayRecords: Long) {
  def jsonData: JValue
}
...
/**
  ...
  */
class DataTableArraySource(totalRecords: Long, totalDisplayRecords: Long, val data: List[List[String]])
...
/**
  ...
  */
class DataTableObjectSource(totalRecords: Long, totalDisplayRecords: Long, val data: List[List[(String, String)]])
  extends DataTableSource(totalRecords, totalDisplayRecords) {
...
class DataTable {
  ...
  /**
    ...
    */
  def render(columns: List[String], fun: (DataTableParams) => DataTableSource, id: String,
             jsonOptions: List[(String, String)], attrs: (String, String)*): Elem = {
  ...
  /**
    ...
    * @param attrs - the attributes that can be added to the table
    */
  def render(columns: List[String], fun: (DataTableParams) => DataTableSource, idOpt: Option[String],
              attrs: (String, String)*): Elem = {
